...
GuildCalendarEvent.DefaultLimits =
{
	[40] =
	{
		ClassLimits =
...
function GuildCalendarEvent:LimitsAreEqual(pOldLimits, pNewLimits)
	...
	if pNewLimits.RoleLimits then
		for vRoleCode, vRoleInfo in pairs(GuildCalendarEvent.RolesInfoByID) do
...
GuildCalendarEvent.ClassInfoByClassID =
{
	DRUID =
	{
		ClassCode = "D",
...
GuildCalendarEvent.ClassInfoByClassCode = {}

for vClassID, vClassInfo in pairs(GuildCalendarEvent.ClassInfoByClassID) do
	vClassInfo.ClassID = vClassID
	GuildCalendarEvent.ClassInfoByClassCode[vClassInfo.ClassCode] = vClassInfo
end
...
GuildCalendarEvent.Roles =
{
	{ID = "H", Name = GuildCalendarEvent.cHRole, Color = RAID_CLASS_COLORS.PRIEST, ColorCode = GuildCalendarEvent.RAID_CLASS_COLOR_CODES.PRIEST},
	{ID = "T", Name = GuildCalendarEvent.cTRole, Color = RAID_CLASS_COLORS.WARRIOR, ColorCode = GuildCalendarEvent.RAID_CLASS_COLOR_CODES.WARRIOR},
	{ID = "R", Name = GuildCalendarEvent.cRRole, Color = RAID_CLASS_COLORS.MAGE, ColorCode = GuildCalendarEvent.RAID_CLASS_COLOR_CODES.MAGE},
	{ID = "M", Name = GuildCalendarEvent.cMRole, Color = RAID_CLASS_COLORS.ROGUE, ColorCode = GuildCalendarEvent.RAID_CLASS_COLOR_CODES.ROGUE},
}

-- RoleInfoByID

GuildCalendarEvent.RoleInfoByID = {}

for vRoleIndex, vRoleInfo in pairs(GuildCalendarEvent.Roles) do
	vRoleInfo.SortOrder = vRoleIndex
	vRoleInfo.Classes = {}
	GuildCalendarEvent.RoleInfoByID[vRoleInfo.ID] = vRoleInfo
end
...
for vClassID, vClassInfo in pairs(GuildCalendarEvent.ClassInfoByClassID) do
	for _, vRoleCode in pairs(vClassInfo.Roles) do
		GuildCalendarEvent.RoleInfoByID[vRoleCode].Classes[vClassID] = true
	end
end
