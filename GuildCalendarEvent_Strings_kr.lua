...
GuildCalendarEvent.cGeneralEventGroup = "일반"
...
GuildCalendarEvent.cDungeonEventGroup = "던전 (Classic)"
GuildCalendarEvent.cOutlandsDungeonEventGroup = "던전 (Burning Crusade)"
GuildCalendarEvent.cWotLKDungeonEventGroup = "던전 (WotLK)"
...
GuildCalendarEvent.cBattlegroundEventGroup = "전장"
GuildCalendarEvent.cOutdoorRaidEventGroup = "Outdoor Raids"

GuildCalendarEvent.cMeetingEventName = "만남"
GuildCalendarEvent.cBirthdayEventName = "생일"
...
GuildCalendarEvent.cLevelRangeFormat = "%i 레벨 부터 %i 레벨"
GuildCalendarEvent.cMinLevelFormat = "%i 레벨 이상"
GuildCalendarEvent.cMaxLevelFormat = "최대 %i 레벨"
GuildCalendarEvent.cAllLevels = "모든 레벨"
GuildCalendarEvent.cSingleLevel = "%i 레벨"

GuildCalendarEvent.cYes = "예. 이벤트에 참가하겠습니다."
GuildCalendarEvent.cNo = "아니오. 이벤트에 참가하지 않습니다."
...
GuildCalendarEvent.cTimeLabel = "시간:"
GuildCalendarEvent.cDurationLabel = "소요시간:"
GuildCalendarEvent.cEventLabel = "이벤트:"
GuildCalendarEvent.cTitleLabel = "타이틀:"
GuildCalendarEvent.cLevelsLabel = "레벨:"
GuildCalendarEvent.cLevelRangeSeparator = "-"
GuildCalendarEvent.cDescriptionLabel = "설명"
GuildCalendarEvent.cCommentLabel = "남길말:"
...
GuildCalendarEvent.cPluralMinutesFormat = "%d 분"
GuildCalendarEvent.cSingularHourFormat = "%d 시간"
GuildCalendarEvent.cPluralHourFormat = "%d 시간"
GuildCalendarEvent.cSingularHourPluralMinutes = "%d 시간 %d 분"
GuildCalendarEvent.cPluralHourPluralMinutes = "%d 시간 %d 분"

GuildCalendarEvent.cNewerVersionMessage = "A newer version is available (%s)"

GuildCalendarEvent.cDelete = "삭제"
...
{
	DRUID = {Male = LOCALIZED_CLASS_NAMES_MALE.DRUID, Female = LOCALIZED_CLASS_NAMES_FEMALE.DRUID, Plural = "드루이드"},
	HUNTER = {Male = LOCALIZED_CLASS_NAMES_MALE.HUNTER, Female = LOCALIZED_CLASS_NAMES_FEMALE.HUNTER, Plural = "사냥꾼"},
	MAGE = {Male = LOCALIZED_CLASS_NAMES_MALE.MAGE, Female = LOCALIZED_CLASS_NAMES_FEMALE.MAGE, Plural = "마법사"},
	PALADIN = {Male = LOCALIZED_CLASS_NAMES_MALE.PALADIN, Female = LOCALIZED_CLASS_NAMES_FEMALE.PALADIN, Plural = "성기사"},
	PRIEST = {Male = LOCALIZED_CLASS_NAMES_MALE.PRIEST, Female = LOCALIZED_CLASS_NAMES_FEMALE.PRIEST, Plural = "사제"},
	ROGUE = {Male = LOCALIZED_CLASS_NAMES_MALE.ROGUE, Female = LOCALIZED_CLASS_NAMES_FEMALE.ROGUE, Plural = "도적"},
	SHAMAN = {Male = LOCALIZED_CLASS_NAMES_MALE.SHAMAN, Female = LOCALIZED_CLASS_NAMES_FEMALE.SHAMAN, Plural = "주술사"},
	WARLOCK = {Male = LOCALIZED_CLASS_NAMES_MALE.WARLOCK, Female = LOCALIZED_CLASS_NAMES_FEMALE.WARLOCK, Plural = "흑마법사"},
	WARRIOR = {Male = LOCALIZED_CLASS_NAMES_MALE.WARRIOR, Female = LOCALIZED_CLASS_NAMES_FEMALE.WARRIOR, Plural = "전사"},
...
GuildCalendarEvent.cTimeDateRangeFormat = "%s\r %s 에서 %s"
...
GuildCalendarEvent.cCalendar = "달력"
