...
GuildCalendarEvent._Alts = {}

function GuildCalendarEvent._Alts:Construct()
	--self:InstallAltMail()
end

function GuildCalendarEvent._Alts:InstallAltMail()
...
function GuildCalendarEvent._Alts:UninstallAltMail()
...
function GuildCalendarEvent._Alts:GetAutoCompleteResults(pText, pInclude, pExclude, pMaxResults, pCursorPosition, ...)
	...
	if true or bit.band(pInclude, AUTOCOMPLETE_FLAG_FRIEND) then
		...
		for vCharacterGUID, vCharacterInfo in pairs(GuildCalendarEvent.RealmData.Characters) do
