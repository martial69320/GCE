...
GuildCalendarEvent.cVersionString = GetAddOnMetadata("GuildCalendarEvent", "Version")
...
GuildCalendarEvent.cBirthdayTitleFormat = "%s's Birthday"
...
GuildCalendarEvent.cAboutAuthor = "Designed and written by Martial69320"
GuildCalendarEvent.cAboutCopyright = "Copyright 20018 - 2018 Martial69320"
...
[[
	<html><body>
	<h1>Multi-guild partnerships make it easy to coordinate events across guilds
	by sharing guild rosters (name, rank, class and level only) with your partner guilds.
	The shared roster will show up in your event Invite tab, where you can mass-select members
	of the partner guild.<br/><br/></h1>
	<h2>To create a partnership:<br/><br/></h2>
	<p>* You and a player from the partner guild must be running a current version Guild Event Calendar 5<br/>
	* Both of you must be viewing the Partners tab in Guild Event Calendar<br/>
	* One of you initiates the partnership by adding the other player using the edit box and button at the bottom of this window<br/>
	* The other player will receive a confirmation dialog, after which the rosters will be exchanged and the partnership will be established</p>
	<h1><br/>Rosters will automatically be checked and re-synchronized as needed.  To maintain maximum combat performance,
	synchronization will not start while you're in combat.</h1>
	</body></html>
]]
...
GuildCalendarEvent.cConfirmPartnerRequest = "%s is requesting a Guild Event Calendar partnership with you."
...
GuildCalendarEvent.cRememberInvites = "Remember event invitation lists"
...
GuildCalendarEvent.cWaitingForServerInvite = "Waiting for server"
GuildCalendarEvent.cAddingInviteFormat = "Adding %s"
...
if GetLocale() ~= "enUS" then
	CALENDAR_FIRST_WEEKDAY = 2		-- 1=SUN 2=MON 3=TUE 4=WED 5=THU 6=FRI 7=SAT
end
...
GuildCalendarEvent.cConfirmReset = "Are you sure you want to reset Guild Event Calendar? You will not lose events, but you will lose partnerships, role assignments, and other local settings."

GuildCalendarEvent.cRespondedDateFormat = "Responded on %s"

GuildCalendarEvent.cInviteErrorMessage = "Canceled invite processing because of a server error: %s"
GuildCalendarEvent.cInvitesCanceledMessage = "Canceled invite processing because the event was closed."

GuildCalendarEvent.cStartDayLabel = "Start week on:"
GuildCalendarEvent.cShowMinimapClock = "Show analog clock on minimap"
